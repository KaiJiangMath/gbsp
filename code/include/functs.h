...
/* Obtain dual box; */
extern void obtDualBox ( double **dBox, double **rBox, int dim );
...
extern tvec<int> fn_obt_half_gIndex			(	tvec<int>			NCpt,
													int				cplxDofs );
...
/* Calculation of convolution of pow('src', order); */
...
extern double fn_obt_mass			(	stu_system_param		*ssysparam,
										tvec<fftw_complex>		rhoJCplx );
